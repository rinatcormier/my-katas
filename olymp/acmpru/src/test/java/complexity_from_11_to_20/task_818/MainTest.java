...
class MainTest {
    ...
    private static Stream<Arguments> candidates() {
        return Stream.of(
                Arguments.of(separatedObjectsAsString("1", "1"), separatedObjectsAsString("1")),
                Arguments.of(separatedObjectsAsString("3", "2 5 4"), separatedObjectsAsString("9")),
                Arguments.of(separatedObjectsAsString("3", "1 1 1"), separatedObjectsAsString("1"))
        );
    }
}
