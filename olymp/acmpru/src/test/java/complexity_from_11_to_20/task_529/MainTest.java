...
class MainTest {
    ...
    private static Stream<Arguments> candidates() {
        return Stream.of(
                Arguments.of(separatedObjectsAsString("3 4 8 4"), separatedObjectsAsString("5")),
                Arguments.of(separatedObjectsAsString("3 4 18 7"), separatedObjectsAsString("15.2971"))
        );
    }
}
