...
class MainTest {
    ...
    private static Stream<Arguments> candidates() {
        return Stream.of(
                Arguments.of(separatedObjectsAsString("3 2 1"), separatedObjectsAsString("4")),
                Arguments.of(separatedObjectsAsString("12 13 5"), separatedObjectsAsString("20")),
                Arguments.of(separatedObjectsAsString("2 5 9"), separatedObjectsAsString("Impossible"))
        );
    }
}