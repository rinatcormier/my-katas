package complexity_from_0_to_10.task_597;
...
class MainTest {
    ...
    private static Stream<Arguments> candidates() {
        return Stream.of(
                Arguments.of(separatedObjectsAsString("10 10 10"), separatedObjectsAsString("NO")),
                Arguments.of(separatedObjectsAsString("10 3 4"), separatedObjectsAsString("YES"))
        );
    }
}