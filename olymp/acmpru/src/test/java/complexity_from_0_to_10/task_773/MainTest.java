package complexity_from_0_to_10.task_773;
...
class MainTest {
    ...
    private static Stream<Arguments> candidates() {
        return Stream.of(
                Arguments.of(separatedObjectsAsString("2 2"), separatedObjectsAsString("8")),
                Arguments.of(separatedObjectsAsString("12 4"), separatedObjectsAsString("576"))
        );
    }
}