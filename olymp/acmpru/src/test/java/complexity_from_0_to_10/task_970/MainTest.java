...
class MainTest {
    ...
    private static Stream<Arguments> candidates() {
        return Stream.of(
                Arguments.of(separatedObjectsAsString("3 5 2"), separatedObjectsAsString("YES")),
                Arguments.of(separatedObjectsAsString("2 2 5"), separatedObjectsAsString("NO")),
                Arguments.of(separatedObjectsAsString("2 2 4"), separatedObjectsAsString("YES")),
                Arguments.of(separatedObjectsAsString("-2 2 4"), separatedObjectsAsString("YES"))
        );
    }
}