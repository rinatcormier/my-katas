...
import beginning.range_sum_queries.Main;
...
class MainTest {
    ...
    private static Stream<Arguments> candidates() {
        return Stream.of(
                Arguments.of(
                        separatedObjectsAsString("7", "2 -1 7 2 -3 -2 4", "2", "1 4", "2 6"),
                        separatedObjectsAsString("8", "4")
                ),
                Arguments.of(
                        separatedObjectsAsString("3", "1 2 3", "4", "0 1", "1 2", "2 3", "0 3"),
                        separatedObjectsAsString("1", "2", "3", "6")
                )
        );
    }
}
