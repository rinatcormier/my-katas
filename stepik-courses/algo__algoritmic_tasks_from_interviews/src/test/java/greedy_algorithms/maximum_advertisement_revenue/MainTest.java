...
class MainTest {
    ...
    private static Stream<Arguments> candidates() {
        return Stream.of(
                Arguments.of(separatedObjectsAsString("1", "23", "39"), separatedObjectsAsString("897")),
                Arguments.of(separatedObjectsAsString("3", "2 3 9", "7 4 2"), separatedObjectsAsString("79"))
        );
    }
}
