...
class MainTest {
    ...
    private static Stream<Arguments> candidates() {
        return Stream.of(
                Arguments.of(separatedObjectsAsString("7"), separatedObjectsAsString("3")),
                Arguments.of(separatedObjectsAsString("73"), separatedObjectsAsString("1")),
                Arguments.of(separatedObjectsAsString("1234567890"), separatedObjectsAsString("0"))
        );
    }
}
